...
const InfoArea = ({
  ...
  return (
    ...
    >
      <div className="relative z-10 order-2 flex w-full shrink-0 flex-col items-center justify-center py-2 lg:order-1 lg:basis-[40%] lg:py-0">
      ...
      >
        ...
        >
          <div className="w-full lg:w-[220px] lg:max-w-none">
            <AnimatedButton
              text="WhatsApp"
              link={whatsappHref}
